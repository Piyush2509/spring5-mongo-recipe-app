...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private final UnitOfMeasureRepository unitOfMeasurementRepository;
	...
	private List<Recipe> getRecipes() {
		...
		// get UOMs
		Optional<UnitOfMeasure> eachUomOptional = unitOfMeasurementRepository.findByDescription("Each");
		if (!eachUomOptional.isPresent()) {
			throw new RuntimeException("Expecetd UOM Not Found");
		}

		Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasurementRepository.findByDescription("Tablespoon");
		if (!tableSpoonUomOptional.isPresent()) {
			throw new RuntimeException("Expecetd UOM Not Found");
		}

		Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasurementRepository.findByDescription("Teaspoon");
		if (!teaSpoonUomOptional.isPresent()) {
			throw new RuntimeException("Expecetd UOM Not Found");
		}

		Optional<UnitOfMeasure> dashUomOptional = unitOfMeasurementRepository.findByDescription("Dash");
		if (!dashUomOptional.isPresent()) {
			throw new RuntimeException("Expecetd UOM Not Found");
		}

		Optional<UnitOfMeasure> pintUomOptional = unitOfMeasurementRepository.findByDescription("Pint");
		if (!pintUomOptional.isPresent()) {
			throw new RuntimeException("Expecetd UOM Not Found");
		}

		Optional<UnitOfMeasure> cupUomOptional = unitOfMeasurementRepository.findByDescription("Cup");
		...
		if (!americanCategoryOptional.isPresent()) {
			throw new RuntimeException("Expecetd Category Not Found");
		}
		...
		guacRecipe.setDescription("Prefect Guacamole");
		...
		guacRecipe.addIngredient(new Ingredient("reipe avacados", new BigDecimal(2), eachUom));
